 ...
 * @author Howard.Li
 */
public final class HkMacaoResidencePermitInfo extends CredentialInfo {
     ...
     * @return this（链式调用）
     */
    public HkMacaoResidencePermitInfo setRegion(DomesticRegionInfo region) {
        this.region = region;
        return this;
    }
     ...
     * @return this（链式调用）
     */
    public HkMacaoResidencePermitInfo setBirthDate(String birthDate) {
     ...
     * @return this（链式调用）
     */
    public HkMacaoResidencePermitInfo setGender(Gender gender) {
        this.gender = gender;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        HkMacaoResidencePermitInfo that = (HkMacaoResidencePermitInfo) o;
    ...
    public String toString() {
        return "HkMacaoResidencePermitInfo{" +
                "region=" + region +
                ", birthDate='" + birthDate + '\'' +
                ", gender=" + gender +
                ", age=" + getAge() +
